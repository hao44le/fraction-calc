    ...
    def output_tex(self):
        with open ("problems.tex", "w") as f:
            ...
            while cnt <= self.amount:
                ...
                f.write(f"&\\frac{{{self.problems[cnt]['numerator_A']}}}{{{self.problems[cnt]['denominator_A']}}} {converted_symbol} \\frac{{{self.problems[cnt]['numerator_B']}}}{{{self.problems[cnt]['denominator_B']}}} = \\qquad \\qquad \\qquad \\qquad \\qquad")
                if cnt % 3 == 0:
                    f.write("\\\\\n")
                    f.write("\\\\\n")
                    f.write("\\\\\n")
